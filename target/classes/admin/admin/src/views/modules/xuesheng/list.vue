		    ...
		    label="宿舍号">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('xuesheng','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('xuesheng','添加缴费') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'添加缴费':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','添加缴费') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'添加缴费':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','添加缴费') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'添加缴费':'' }}</el-button>
                                                <el-button v-if="isAuth('xuesheng','卫生检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生检查':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','卫生检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生检查':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','卫生检查') && contents.tableBtnIcon == 0" type="success" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生检查':'' }}</el-button>
